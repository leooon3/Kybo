...
abstract class AppLocalizations {
  ...
  /// No description provided for @errorLoadDiet.
  ///
  /// In it, this message translates to:
  /// **'Impossibile caricare la dieta.'**
  String get errorLoadDiet;

  /// No description provided for @errorCloudSync.
  ///
  /// In it, this message translates to:
  /// **'Errore sincronizzazione Cloud.'**
  String get errorCloudSync;
